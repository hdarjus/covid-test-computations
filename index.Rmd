...
Austria has a population of about 9 million, so if I walk around the streets and think that everyone is COVID-free then I am wrong about $\frac{300000}{9000000} = `r covid <- round(3/90, 4); nocovid <- 1 - covid; covid*100`\%$.
...
*How much more do I know about my friends' health with the negative test result?*
